...
const PROCEDURE_TEMPLATES = {
  ...
  'Prepayments & Other Receivables': [
    ...
    { description: 'Obtain management representation on existence, recoverability, and classification of other receivables', type: 'documentation' },
  ],
  'Inventory': [
  ...
  'Provisions & End-of-Service Benefits': [
    ...
    { description: 'Evaluate management classification of contingent items under IAS 37 (probable / possible / remote) and corresponding recognition vs disclosure treatment', type: 'documentation' },
    ...
    { description: 'Obtain written management representation on completeness of provisions, contingent liabilities, and commitments disclosed', type: 'documentation' },
  ],
  ...
  'Cost of Sales': [
    ...
    { description: 'Verify inventory costing method (FIFO / Weighted Average) is consistent with prior period and entity accounting policy', type: 'documentation' },
  ...
  'Related Parties': [
    ...
    { description: 'Test disclosures in financial statements for compliance with IAS 24', type: 'documentation' },
  ],
  'Subsequent Events': [
    ...
    { description: 'Obtain management representation regarding subsequent events', type: 'documentation' },
  ],
  'Going Concern': [
  ...
  'Journal Entry Testing': [
    ...
    { description: 'Document journal entry testing approach, selection criteria, exceptions identified, and overall conclusion on fraud risk per ISA 240', type: 'documentation' },
  ],
  'Out of Scope / Below Materiality': [
    { description: 'Document the performance materiality threshold determined for the engagement and the basis of calculation per ISA 320', type: 'documentation' },
    ...
    { description: 'Document justification for not performing substantive procedures on these balances, considering both quantitative and qualitative materiality factors', type: 'documentation' },
    { description: 'Confirm via final review that no individually significant or qualitatively sensitive item (related party, fraud-prone, restricted, regulatory) is included in this aggregation', type: 'documentation' },
  ],
};
