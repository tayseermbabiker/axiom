...
const PROCEDURE_TEMPLATES = {
  ...
  'Going Concern': [
    { description: 'Obtain management\'s going concern assessment covering a period of at least twelve months from the reporting date (ISA 570.13). Document the period assessed and confirm it meets the minimum requirement; if shorter, request management to extend it', type: 'test_of_detail' },
    ...
    { description: 'If one or more indicators are present, evaluate whether they constitute a MATERIAL UNCERTAINTY (ISA 570.18). Material uncertainty exists where events/conditions, individually or together, may cast significant doubt on the entity\'s ability to continue as a going concern. Document: (a) which indicators are present, (b) management\'s mitigating plans, (c) whether those plans are feasible (evidence-supported, not management assertion), (d) the audit team\'s conclusion on whether a material uncertainty exists', type: 'other' },
