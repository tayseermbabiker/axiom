...
- ⬜ **#1 AML / KYC / CDD module** (regulatory — DNFBP) — client identity, beneficial ownership, PEP/sanctions screening, AML risk rating, source of funds. Permanent file, pre-acceptance. **MENA-agnostic** (no goAML hardcode). Acceptance/ISQM 1 link. Marketable compliance moat.
